      ...
      <div className="card-body p-4">
        ...
        <div className="flex flex-wrap gap-2">
          {recipe.cookTimeMinutes != null && (
            <div className="badge badge-neutral badge-sm gap-1 px-2">
              <svg
              ...
              <span className="text-nowrap">{recipe.cookTimeMinutes} min</span>
            </div>
          )}
          {recipe.portionAmount != null && (
            <div className="badge badge-neutral badge-sm px-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="none"
